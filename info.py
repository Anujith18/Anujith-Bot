...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1727225499').split()]
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Anujith1bot:Anujith1bot@cluster0.xoaog.mongodb.net/Anujith1bot?retryWrites=true&w=majority&appName=Cluster0")
...
VERIFY2_API = environ.get('VERIFY2_API', "89b698ba1fb405905af84b29c0257e78fe3d90c3")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002015288592')).split()]
