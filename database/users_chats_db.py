...
from info import DATABASE_NAME, COLLECTION_NAME, IMDB, IMDB_TEMPLATE, MELCOW_NEW_USERS, P_TTI_SHOW_OFF, SINGLE_BUTTON, SPELL_CHECK_REPLY, PROTECT_CONTENT, AUTO_DELETE, MAX_BTN, AUTO_FFILTER, SHORTLINK_API, SHORTLINK_URL, IS_SHORTLINK
...
class Database:
    ...
    def __init__(self, database_name):
        ...
        self._client = motor.motor_asyncio.AsyncIOMotorClient(os.getenv("MONGODB_URI"))  # Set this in Koyeb
        self.db = self._client[database_name]
        self.col = self.db.users
        self.grp = self.db.groups
        
        # Secondary DB
        self._client2 = motor.motor_asyncio.AsyncIOMotorClient(os.getenv("SECOND_MONGODB_URI"))  # Set this in Koyeb
    ...
    async def add_user(self, id, name):
        ...
        if tempDict['indexDB'] == os.getenv("MONGODB_URI"):
